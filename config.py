...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002279722121"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002733994921"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6763725032 7334816122").split()):
        ADMINS.append(int(x))
except ValueError:
