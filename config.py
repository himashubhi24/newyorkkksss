...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "4816f9adc5f0609b985b4da8ff42ccbc0511df03")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002222327430"))
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n\n<b>You need to join in @foxylinkk my Channel/Group ")
